...
import image from "../../public/inticure_assurance.jpg";

const Assurance = () => {
  return (
    <div className="h-100 bg-white -mt-10 z-10">
      <div className="relative w-full flex flex-col h-96 gap-10 overflow-hidden">
        <img src={image} alt="d" className="w-full h-full object-cover" />
        <div className="flex z-10 inset-0 justify-center -mt-64">
          <h1 className="text-white text-5xl text-center -mt-24">
        ...
        <div className="flex justify-center">
          <p className="text-white text-center">
            ...
            <br /> without feeling judged or embarassed. Our medical specialists
            are here to <br />
